...
final readonly class KsefTokenHandler extends AbstractHandler
{
    ...
    public function handle(KsefTokenRequest $request): ResponseInterface
    {
        return $this->client->sendRequest(new Request(
            method: Method::Post,
            uri: Uri::from('auth/ksef-token'),
            body: $request->toBody(),
        ));
    }
}
